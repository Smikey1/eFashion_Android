package com.hdd.globalmovie.data.remoteDataSource
...
object ServiceBuilder {
    ...
    // for mbl deployment
//    private const val BASE_URL="http://192.168.1.168:90/"
...
//    private const val BASE_URL="http://localhost:90/"
    ...
    var uid:String? = null
    var user: User? = null
    var latestOrderId:String? = null
    var singleOrderPrice:Int?=null
    var alreadyInWishlist:Boolean?=false
