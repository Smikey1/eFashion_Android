...
class WishlistUITest {
    ...
    fun wishlistUITest() {
        val materialButton = onView(
            allOf(
                withId(R.id.btnNavigateToLogin), withText("Login"),
                childAtPosition(
                    childAtPosition(
        ...
        appCompatEditText.perform(replaceText("hello@text.com"), closeSoftKeyboard())
